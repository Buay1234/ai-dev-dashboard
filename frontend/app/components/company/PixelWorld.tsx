...
function PixelWorld({ currentAgent, statuses, latestMessages = {} }: Props) {
  ...
  return (
    <div className="relative mx-auto w-full max-w-4xl">
      <div
        className="relative w-full overflow-hidden rounded-lg border-2 border-cyan-500/30 shadow-[0_0_32px_rgba(6,182,212,0.12),inset_0_0_48px_rgba(0,0,0,0.5)]"
        style={{
      ...
      >
        ...
        {missionComplete && (
          <motion.div
            className="pointer-events-none absolute inset-x-0 top-2 z-30 text-center text-[9px] font-mono uppercase tracking-[0.2em] text-amber-300 drop-shadow-[0_0_8px_rgba(245,158,11,0.6)]"
        ...
        {/* Character layer — absolute % positioning on map */}
