...
Generated by AI Dev Dashboard V23 · Real Database & Migration Generator
...
export function getProjectGenerationSteps(entities: ReturnType<typeof extractEntities>) {
  return [
    ...
    { id: "sql", label: "SQL Schema Generated", done: true },
    { id: "ef", label: "EF Migration Generated", done: true },
